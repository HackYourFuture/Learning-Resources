...
--   6a. Create vw_dim_zones from raw_zones and vw_fact_trips from raw_trips,
...
-- 6a. The two views
-- TODO: CREATE OR REPLACE VIEW vw_dim_zones from raw_zones.
-- TODO: CREATE OR REPLACE VIEW vw_fact_trips from raw_trips, excluding negative fares.
