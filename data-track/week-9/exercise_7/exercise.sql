...
-- TODO: EXPLAIN a CROSS JOIN of raw_trips and raw_zones (no ON clause).


-- Filtered join: one zone per trip
-- TODO: EXPLAIN an INNER JOIN of raw_trips and raw_zones on pickup_location_id = location_id.
